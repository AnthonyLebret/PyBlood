...
st.header("Objectif")
st.write("Etablir un **système de reconnaissance** des globules blancs reposant sur la **segmentation d'image** et la **classification** par des modèles d'apprentissage automatique.")
